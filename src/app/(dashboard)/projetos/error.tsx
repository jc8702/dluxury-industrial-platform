...
export default function ProjetosError({
  ...
  useEffect(() => {
    console.error('Projetos Error Boundary:', error);
  }, [error]);
  ...
  return (
    <div className="p-8 bg-[#0F1115] min-h-screen text-slate-200 font-sans flex flex-col items-center justify-center">
      <div className="max-w-md w-full bg-[#1A1D24] border border-slate-800 p-8 rounded-2xl shadow-xl text-center">
        ...
        <h2 className="text-2xl font-bold text-white tracking-tight mb-2">Erro na Biblioteca de Projetos</h2>
        <p className="text-slate-400 text-sm mb-6">
          Não conseguimos carregar a biblioteca de arquivos 3D ou sincronizar com o bucket Cloudflare R2.
        </p>
