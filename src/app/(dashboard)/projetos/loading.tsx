...
export default function ProjetosLoading() {
  return (
    <div className="p-8 bg-[#0F1115] min-h-screen text-slate-200 font-sans animate-pulse">
      ...
      {/* Search Bar Skeleton */}
      <div className="h-14 w-full bg-[#1A1D24] border border-slate-800 rounded-xl mb-8"></div>

      {/* Grid Skeleton */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="bg-[#1A1D24] border border-slate-800 rounded-xl overflow-hidden shadow-sm h-96 flex flex-col justify-between">
            <div className="h-36 bg-slate-800/60 p-4"></div>
            <div className="p-5 flex-1 space-y-4">
              <div className="flex justify-between">
                <div className="h-3.5 w-12 bg-slate-800 rounded-md"></div>
                <div className="h-3.5 w-24 bg-slate-800 rounded-md"></div>
              </div>
              <div className="flex justify-between">
              ...
              <div className="flex justify-between">
                <div className="h-3.5 w-20 bg-slate-800 rounded-md"></div>
                <div className="h-3.5 w-24 bg-slate-800 rounded-md"></div>
              </div>
