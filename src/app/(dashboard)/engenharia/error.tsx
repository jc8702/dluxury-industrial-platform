...
export default function EngenhariaError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    // Registra o erro no console ou em serviços de monitoramento (Sentry/Axiom)
    console.error('Engenharia Error Boundary:', error);
  }, [error]);
  ...
  return (
    <div className="p-8 bg-[#0F1115] min-h-screen text-slate-200 font-sans flex flex-col items-center justify-center">
      <div className="max-w-md w-full bg-[#1A1D24] border border-slate-800 p-8 rounded-2xl shadow-xl text-center">
        ...
        <h2 className="text-2xl font-bold text-white tracking-tight mb-2">Erro no Módulo de Engenharia</h2>
        <p className="text-slate-400 text-sm mb-6">
          Houve uma falha ao renderizar as especificações paramétricas ou o banco de dados de insumos.
        </p>
