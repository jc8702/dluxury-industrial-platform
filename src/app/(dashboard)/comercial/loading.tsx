    ...
    <div className="p-8 bg-[#0F1115] min-h-screen text-slate-200 font-sans animate-pulse">
      ...
      <div className="bg-[#1A1D24] border border-slate-800 rounded-xl overflow-hidden shadow-sm">
        ...
        <div className="p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {[1, 2, 3, 4].map((col) => (
            <div key={col} className="bg-[#0F1115] border border-slate-800 rounded-xl p-4 min-h-[300px] space-y-3">
              <div className="h-5 w-24 bg-slate-800 rounded-md mb-4"></div>
              {[1, 2, 3].map((card) => (
                <div key={card} className="bg-[#1A1D24] border border-slate-800 p-3 rounded-lg space-y-2">
                  <div className="h-4 w-28 bg-slate-800 rounded-md"></div>
                  <div className="h-3 w-16 bg-slate-800/60 rounded-md"></div>
                  <div className="flex justify-between pt-2">
                    <div className="h-3 w-10 bg-slate-800/40 rounded-md"></div>
